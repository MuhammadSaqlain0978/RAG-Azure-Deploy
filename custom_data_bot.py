...
class UniversityRAGBot:
    ...
    def __init__(self, api_key, model_name="mistral-small"):
    ...
    def load_university_data(self, database_folder="database", vector_store_path="./vector_store"):
        ...
        text_splitter = RecursiveCharacterTextSplitter(
            chunk_size=800,      # Smaller chunks for university info
...
def main():
    ...
    selected_model = model_map.get(model_choice, "mistral-small-latest")
    ...
    database_folder = input("📂 Enter database folder path (or press Enter for 'database'): ").strip()
    if not database_folder:
        database_folder = "database"
    
    # Vector store path
    vector_store_path = "./database_vector_store"
